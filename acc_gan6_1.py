...
parser.add_argument('--ckpt-path', default="standford10_1.ckpt", help="path of pth file", type=str)
...
parser.add_argument('--epochs', default=100, help="training epoch", type=int)
...
def test(prenet,net, testloader, load_path = 'stanford10.ckpt'):
...
if __name__ == '__main__':
    ...
    if mode == "traintest":
        ...
        test(prenet,net, testloader, ckpt_path)
    elif mode == "train":
        train(prenet,net, trainloader, epochs,ckpt_path)
    else:
        test(prenet,net, testloader, ckpt_path)
