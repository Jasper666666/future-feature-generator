...
print(file_names)
f_feature=open('hmdb_features'+str(interval)+'.txt','w')
f_imgs=open('hmdb_imgs'+str(interval)+'.txt','w')
num=0
    ...
    for v_name in os.listdir(new_path):
        ...
        for im in enumerate(video):
            ...
            if im[0]==(5+interval):
                ...
                feature30.squeeze(0)
                img5.save('./hmdb_imgs'+str(interval)+'/a'+str(num)+'.jpg')
                f_imgs.write('/hmdb_imgs'+str(interval)+'/a'+str(num)+'.jpg\n')
                np.save('./hmdb_f'+str(interval)+'/a'+str(num)+'.npy',feature30)
                f_feature.write('/hmdb_f'+str(interval)+'/a'+str(num)+'.npy\n')
            if im[0]==10:
            ...
            if im[0]==(10+interval):
                ...
                feature35.squeeze(0)
                img10.save('./hmdb_imgs'+str(interval)+'/b'+str(num)+'.jpg')
                f_imgs.write('/hmdb_imgs'+str(interval)+'/b'+str(num)+'.jpg\n')
                np.save('./hmdb_f'+str(interval)+'/b'+str(num)+'.npy',feature35)
                f_feature.write('/hmdb_f'+str(interval)+'/b'+str(num)+'.npy\n')
            if im[0]==15:
            ...
            if im[0]==(15+interval):
                ...
                feature40.squeeze(0)
                img15.save('./hmdb_imgs'+str(interval)+'/c'+str(num)+'.jpg')
                f_imgs.write('/hmdb_imgs'+str(interval)+'/c'+str(num)+'.jpg\n')
                np.save('./hmdb_f'+str(interval)+'/c'+str(num)+'.npy',feature40)
                f_feature.write('/hmdb_f'+str(interval)+'/c'+str(num)+'.npy\n')
                break
